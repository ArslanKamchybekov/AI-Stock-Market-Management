...
exports.screen = exports.fireEvent = exports.cleanup = exports.act = exports.fireTouchChangedEvent = exports.createRenderer = void 0;
/* eslint-env mocha */
...
Object.defineProperty(exports, "cleanup", { enumerable: true, get: function () { return pure_1.cleanup; } });
...
function createRenderer(globalOptions = {}) {
    const { clock: clockMode = 'real', clockConfig, strict: globalStrict = true, strictEffects: globalStrictEffects = globalStrict, } = globalOptions;
...
exports.screen = (0, pure_1.within)(document.body, { ...pure_1.queries, ...customQueries });
